...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.8.0-64-g951557ebd1/BNBAcneEyebagsRemoval.zip",
            checksum: "cf19d564da947a293f9ef885b9a8f707b7fbe3fcffe8e1b18b4e5e0b07fd7ef6"
        ),
        .target(
