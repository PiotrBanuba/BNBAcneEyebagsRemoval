...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.8.0-62-g077d3df291/BNBAcneEyebagsRemoval.zip",
            checksum: "82a805065e12c2e242c2130c43be97122ff385218e44ae0aa632d1071ed725dd"
        ),
        .target(
