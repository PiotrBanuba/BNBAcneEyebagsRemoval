...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.8.0-61-g2b7f7b2a6c/BNBAcneEyebagsRemoval.zip",
            checksum: "ab318148d699e687878e66fac6e416099a1e260c4b306cc9aa34ef2cba7d3187"
        ),
        .target(
